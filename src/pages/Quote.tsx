      ...
      <section className="py-20 md:py-28">
        <div className="section-shell grid gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:self-start">
            <h2 className="text-balance text-3xl font-black tracking-normal text-[#4b4a48] md:text-4xl">
            ...
            <div className="mt-8 rounded-2xl border border-[#cdcdcd] bg-[#f0eedc] p-5 text-sm leading-6 text-[#4b4a48]">
