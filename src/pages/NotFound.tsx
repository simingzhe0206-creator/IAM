  ...
  return (
    <section className="section-shell grid min-h-[70dvh] place-items-center py-20 text-center">
      <div className="page-canvas p-8 md:p-12">
          ...
          <h1 className="mt-5 text-balance text-5xl font-black tracking-normal text-[#f0eedc] md:text-7xl">
          This survey mark is not on the plan.
        </h1>
        <p className="mx-auto mt-5 max-w-xl text-lg leading-8 text-[#cdcdcd]">
